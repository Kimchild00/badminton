            ...
            @foreach($tempats as $tempat)
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        ...
                        @if($tempat->image)
                            <img src="{{ asset('storage/images/'.$tempat->image) }}" class="img-fluid" alt="...">
                        @endif
                            <!-- <img class="img-fluid" src="img/course-1.jpg" alt=""> -->
                            <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                <!-- <a href="#" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a> -->
                                <!-- {{--<a href="{{ url('detail-booking/'. $tempat->id) }}" class="flex-shrink-0 btn btn-sm btn-primary px-3 " style="border-radius: 30 30px 30px 30; font-size: 20px;">Booking</a>--}} -->
                                <!-- {{-- <a href="{{ route('booking', ['number' => $tempat->number])  }}" class="flex-shrink-0 btn btn-sm btn-primary px-3">Booking</a> --}} -->
                                <a href="{{ url('detail-booking/'. $tempat->id) }}" class="btn btn-primary" style="border-radius: 30 30px 30px 30; font-size: 20px;">Booking</a>
                        </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex border-top">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Operator</small>
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-danger me-2"></i>Jam Tutup</small>
                            <a href='https://goo.gl/maps/iDSvku38w2HEXiaw6' class="btn flex-fill text-center py-2">
