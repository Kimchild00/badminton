            ...
            <div class="row">
                @foreach($tempats as $tempat)
                    <div class="col-lg-4 mb-5">
                        ...
                        @if($tempat->image)
                            <img src="{{ asset('storage/images/'.$tempat->image) }}" class="card-img-top" alt="...">
                        @endif
                        <div class="card-body">
        ...
        <div class="sign-up-htm">
            ...
            @csrf
				<div class="group">
					...
					<input id="nama" type="text" class="input @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
				@error('name')
					<span class="invalid-feedback" role="alert">
						<strong>{{ $message }}</strong>
					</span>
				...
				<div class="group">
					...
					<input id="email" type="email" class="input @error('password') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
				@error('password')
					<span class="invalid-feedback" role="alert">
						<strong>{{ $message }}</strong>
					</span>
